var RESERVED = ['class', 'override', 'func', '@interface', '@end',
   'if', 'while', 'for', 'then', 'else', 'do', 'repeat', 'until', 'with', 'and',
   'or', 'xor', 'is', 'in', 'out', 'div', 'mod', 'static', 'method', 'local', 'global',
   'yield', 'return', 'break', 'continue', 'where', 'change', 'map', 'filter', 'any', 'all', 'forget', 'not', 'var', 'extract', 'transparent', 'breakable', 'continuable', 'print', 'switch', 'case', 'void', 'public', 'private', 'protected', 'extends', 'final', 'super', 'NULL', 'default', 'inline', 'static', 'typedef', 'struct', 'bool', 'int', 'enum', 'union', 'unsigned', 'long', 'double', 'true', 'false', 'char', 'read', 'write', 'from', 'map', 'set'];

var CLASSES = ['TriangleView', 'UIView', 'StyleKit', 'UIImage', 'void', 'NSShadow', 'PCGradient', 'UIColor', 'NSObject', 'CGRect', 'MyStyleKit',
...
'Class', 'Method', 'System', 'Range', 'Iterator', 'infinity', 'MetaClass', 'ArchClass', 'FiniteIterator', 'Pair', 'Dictionary', 'File', 'Canvas', 'Turtle', 'ObjectRef', 'ULONG', 'MachineRef', 'BYTE', 'char', 'charRef', 'WorkerRef', 'SourcePosition', 'StringRef', 'CompilerRef', 'FreePolicy', 'ScannerRef', 'ParserRef', 'GeneratorRef', 'NodeRef', 'TokenRef', 'LONG', 'DOUBLE', 'UIBezierPath', 'CGFloat', 'StyleKitNameResizingBehavior'];
   
var CONSTRUCTS = [
   'var', 'method', 'function', 'slot', 'native', 'property'
];
...
{	
    ...
    result += "<span class='"+lexem+"'>" + text.substring(from, i).replace(" ", "&nbsp;").replace("<", "&lt;").replace(">", "&gt;").replace("\n", "") + "</span>";
...
function highlightAll()
{
    ...
    {
        if (hasClass(elementsToHighlight[i], "noSyntax"))
            continue;
